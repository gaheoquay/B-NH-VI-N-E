...
let GET_BOOKING_BY_USERID = BASE_URL + "/Booking/GetBookingByUserId"
...
let GET_SCHEDULE = BASE_URL + "/Booking/GetBookingRecordFromTodayByUserId"
...
let GO_TO_SCHEDULE = "GO_TO_SCHEDULE"
let RELOAD_BOOKING = "RELOAD_BOOKING"
