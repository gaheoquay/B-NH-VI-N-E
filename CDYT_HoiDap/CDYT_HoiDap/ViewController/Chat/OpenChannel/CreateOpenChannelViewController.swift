...
class CreateOpenChannelViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        let rightItem = UIBarButtonItem(title: "Tạo", style: UIBarButtonItemStyle.plain, target: self, action: #selector(createOpenChannel))
    ...
    @objc private func createOpenChannel() {
        ...
        SBDOpenChannel.createChannel(withName: self.openChannelNameTextField.text, coverUrl: nil, data: nil, operatorUsers: nil) { (channel, error) in
            ...
            let vc = UIAlertController(title: "Open Channel Created", message: "Open channel is created.", preferredStyle: UIAlertControllerStyle.alert)
