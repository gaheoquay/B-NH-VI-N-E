...
class OpenChannelChattingViewController: UIViewController, SBDConnectionDelegate, SBDChannelDelegate, ChattingViewDelegate, MessageDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @objc private func openMoreMenu() {
        ...
        let seeParticipantListAction = UIAlertAction(title: "See participant list", style: UIAlertActionStyle.default) { (action) in
            DispatchQueue.main.async {
    ...
    func clickProfileImage(viewCell: UITableViewCell, user: SBDUser) {
        ...
        let startDistinctGroupChannel = UIAlertAction(title: "Open Distinct Group Channel", style: UIAlertActionStyle.default) { (action) in
        ...
        let startNonDistinctGroupChannel = UIAlertAction(title: "Open Non-Distinct Group Channel", style: UIAlertActionStyle.default) { (action) in
        ...
        let blockUserAction = UIAlertAction(title: "Chặn người dùng", style: UIAlertActionStyle.default) { (action) in
