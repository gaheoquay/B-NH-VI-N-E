...
//        self.navItem.rightBarButtonItems = [negativeRightSpacer, rightCreateGroupChannelItem, rightEditItem]
    ...
    private func setEditableNavigationItems() {
        ...
        let leftBackItem = UIBarButtonItem(title: "Xong", style: UIBarButtonItemStyle.plain, target: self, action: #selector(done))
...
//        self.dismiss(animated: false, completion: nil)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if self.editableChannel == true {
            ...
            let leaveButton = MGSwipeButton(title: "Bỏ", backgroundColor: Constants.leaveButtonColor())
            let hideButton = MGSwipeButton(title: "Ẩn", backgroundColor: Constants.hideButtonColor())
